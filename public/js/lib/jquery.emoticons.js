...
exports.replace = function(text, fn) {
    return text.replace(regexp, function(code) {
        ...
        return (fn || exports.tpl)(name, code, (emoticons[name]!==undefined && emoticons[name].title!==undefined)?emoticons[name].title:'');
    });
};
...
exports.tpl = function(name, code, title) {
    ...
    return '<span class="smile-item '+_class+' emoticon-' + name + '" data-code="'+code+'" title="' + title + '">' +
        code + '</span>';
};
